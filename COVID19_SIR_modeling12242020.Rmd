...
New Jersey is a bit of an exception, although it does not make the top ten in number of cases it is top five in number of COVID-19 deaths(Table \@ref(tab:dead-table)).
...
covid_totals %>%
  ...
  kable(
    position = "H",
    col.names = c('State', '% Population Dead'),
    row.names = seq(1, 10),
...
As of this writing the mortality rate in most states is under 3% (Fig.\@ref(fig:map-mortality)).
